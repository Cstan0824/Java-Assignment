...
public class ViewItem {
    ...
    private void displayItemDetails() {
        ...
        System.out.println(
                " =========================================================================================== Items ================================================================================================= ");
        System.out.println(
                String.format("| %-5s | %-20s | %-20s | %-40s | %-50s | %-20s | %-20s |", "No.", "Item Category", "Vendor", "Item Name",
                        "Item Description", "Price (in MYR)", "Stock Level"));
        System.out.println(" =================================================================================================================================================================================================== ");

        for (int i = 0; i < items.size(); i++) {
            items.get(i).Get();
            System.out.println(
                    String.format("| %-5s %-150s %-20d |", (i + 1) + ". ", items.get(i), items.get(i).getItem_Quantity())); // Display items with index
        }
        System.out.println(" =================================================================================================================================================================================================== ");
    }
